...
<div align ="center" class="container center_div">
	<form method="post" action="addEmployee_Offense_DisciplineStaff.php">
	...
	<br>
	<div >
	<a href="readEmployee_Offense_Discipline.php" class="btn btn-secondary btn-lg active" role="button" >Employee Offense/Discipline</a>
	</div>
	<br>
