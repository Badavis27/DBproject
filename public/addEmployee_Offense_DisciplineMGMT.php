...
<div align ="center" class="container center_div">
	<form method="post" action="addEmployee_Offense_DisciplineMGMT.php">
	...
	<br>
	<div >
	<a href="delete_editEmployee_Offense_DisciplineMGMT.php" class="btn btn-secondary btn-lg active" role="button" >Employee Offense/Discipline</a>
	</div>
	<br>
