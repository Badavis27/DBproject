...
if($result && $result->num_rows >= 1 ){
	...
	while($row = $result->fetch_assoc()){
		...
		<td class="table-danger"><a href="deleteOffenseMGMT.php?id=<?php echo urlencode($row["OD_idnum"]); ?>" onclick="return confirm('Are you sure you want to delete?');">Delete</a></td>
		
		<td class="table-warning"><a href="editOffenseMGMT.php?id=<?php echo urlencode($row["OD_idnum"]); ?>">Edit</a></td>
