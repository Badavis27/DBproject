...
<div align ="center" class="container center_div">
	<form method="post" action="addEmployee_TrainingStaff.php">
	...
	<br>
	<div >
	<a href="readEmployee_Training.php" class="btn btn-secondary btn-lg active" role="button" >Employee Training</a>
	</div>
	<br>
