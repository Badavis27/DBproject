  ...
  $result = $mysqli->query($query);
	...
	if($result) {
	 $row = $result->fetch_assoc();
	  ...
	  echo "<p><form action = 'editTrainingMGMT.php?id={$ID}' method='post'>";
	  ...
	  echo "</form>";
	 echo "<div >
			<a href='delete_editEmployee_TrainingMGMT.php' class='btn btn-secondary btn-lg active' role='button' >Employee Offense/Discipline</a>
			</div>
			<br>
