...
if($result && $result->num_rows >= 1 ){
	...
	echo "<tr style='background-color: #026670'> <th>id</th> <th>First Name</th> <th>Last Name</th> <th>DOH</th> <th>Job Title</th> <th>Cottage</th> <th>Shift</th> <th>Active</th> <th>Pin</th> <th>Edit</th> </tr>";
	while($row = $result->fetch_assoc()){
		...
		<td class="table-warning"><a href="editStaff.php?id=<?php echo urlencode($row["employee_idnum"]); ?>">Edit</a></td>
