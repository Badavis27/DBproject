...
<div align ="center" class="container center_div">
	<form method="post" action="addEmployee_TrainingMGMT.php">
	...
	<br>
	<div >
	<a href="delete_editEmployee_TrainingMGMT.php" class="btn btn-secondary btn-lg active" role="button" >Employee Training</a>
	</div>
	<br>
